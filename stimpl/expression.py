...
class IntLiteral(Literal):
  def __init__(self, literal):
    if type(literal) != int:
      raise InterpTypeError(f"Integer literal cannot be {pretty_type(literal)}")
    super().__init__(literal)

class FloatingPointLiteral(Literal):
  def __init__(self, literal):
    if type(literal) != float:
      raise InterpTypeError(f"Floating-point literal cannot be {pretty_type(literal)}")
    super().__init__(literal)
...
class BooleanLiteral(Literal):
  def __init__(self, literal):
    if type(literal) != bool:
      raise InterpTypeError(f"Boolean literal cannot be {pretty_type(literal)}")
    super().__init__(literal)
